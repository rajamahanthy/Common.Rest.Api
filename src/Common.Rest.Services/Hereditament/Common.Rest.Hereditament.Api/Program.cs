...
builder.Services.AddScoped<IHereditamentMappingService, HereditamentMappingService>();
builder.Services.AddScoped<IHereditamentService, HereditamentService>();
...
var dbConn = builder.Configuration.GetConnectionString("HereditamentDb");
...
app.Logger.LogInformation("Hereditament Service starting...");
app.Run();
