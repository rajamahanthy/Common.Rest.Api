namespace Common.Rest.Hereditament.Api.Tests.Fixtures;
...
{
    protected Mock<IHereditamentService> MockHereditamentService { get; private set; } = null!;
    protected HereditamentController Controller { get; private set; } = null!;

    [TestInitialize]
    public void Initialize()
    {
        MockHereditamentService = new();
        Controller = new HereditamentController(MockHereditamentService.Object);
