...
public class HereditamentControllerTests : ControllerTestBase
{
    ...
    public async Task GetHereditamentById_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.GetHereditamentById(invalidId));
    }
    ...
    public async Task UpdateHereditament_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.UpdateHereditament(invalidId, updateDto));
    }
    ...
    public async Task DeleteHereditament_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.DeleteHereditament(invalidId));
    }
    ...
    public async Task PermanentlyDeleteHereditament_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.PermanentlyDeleteHereditament(invalidId));
    }
    ...
    public async Task RestoreHereditament_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.RestoreHereditament(invalidId));
    }
