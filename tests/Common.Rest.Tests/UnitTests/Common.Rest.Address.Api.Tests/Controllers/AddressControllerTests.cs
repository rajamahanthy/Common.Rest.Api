...
public class AddressControllerTests : ControllerTestBase
{
    ...
    public async Task GetAddressById_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.GetAddressById(invalidId));
    }
    ...
    public async Task UpdateAddress_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.UpdateAddress(invalidId, updateDto));
    }
    ...
    public async Task DeleteAddress_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.DeleteAddress(invalidId));
    }
    ...
    public async Task PermanentlyDeleteAddress_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.PermanentlyDeleteAddress(invalidId));
    }
    ...
    {
        await Assert.ThrowsAsync<ValidationException>(() => Controller.SearchByUprn(""));
        await Assert.ThrowsAsync<ValidationException>(() => Controller.SearchByUprn(null!));
        await Assert.ThrowsAsync<ValidationException>(() => Controller.SearchByUprn("   "));
    }
    ...
    public async Task SearchByUprn_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.SearchByUprn(uprn));
    }
    ...
    public async Task RestoreAddress_NotFound_ThrowsNotFoundException()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => Controller.RestoreAddress(invalidId));
    }
